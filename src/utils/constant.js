globalThis.CONSTANTS = {
  ...
  BASE_URL: process.env.NODE_ENV === 'development' ? 'http://127.0.0.1:5000' : 'http://122.51.216.157:5000',
  STATIC_URL: process.env.NODE_ENV === 'development' ? 'http://127.0.0.1:5000' : 'http://122.51.216.157:5000',
  // LOGO_TITLE: '越泰科技',
