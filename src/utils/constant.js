globalThis.CONSTANTS = {
  ...
  BASE_URL: process.env.NODE_ENV === 'development' ? 'http://localhost:5000' : 'http://logistics-admin:9092',
  STATIC_URL: process.env.NODE_ENV === 'development' ? 'http://localhost:5000' : 'http://logistics-admin:9092',
  LOGO_TITLE: '越泰科技',
  SYSTEM_NAME: '高精度物流智能调度与算力管理系统',
